    ...
    <div className={`${shouldSnapCenter} border-b border-main flex justify-between items-center p-4 md:px-16`}>
      <div className="flex items-center gap-4">
        <Link to="/" className="text-lg md:text-xl font-medium">
          <span className="text-gray-500 dark:text-gray-200">Poetic</span>
          <span className="text-slate-700 dark:text-gray-400">Duniya</span>
          <span className="text-green-700 dark:text-green-500">.me</span>
        </Link>
        <Search />
      </div>
